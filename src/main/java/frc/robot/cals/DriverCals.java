...
public class DriverCals extends CalSet {
    ...
    public MotorCal[] turnMotors = {   
        MotorCal.spark( 5).pid(0.2, 0, 0.25, 0).dFilt(0.01).limit(0.25).brake().ramp(0.001), 
        MotorCal.spark( 4).pid(0.2, 0, 0.25, 0).dFilt(0.01).limit(0.25).brake().ramp(0.001), 
        MotorCal.spark(10).pid(0.2, 0, 0.25, 0).dFilt(0.01).limit(0.25).brake().ramp(0.001), 
        MotorCal.spark(11).pid(0.2, 0, 0.25, 0).dFilt(0.01).limit(0.25).brake().ramp(0.001)};
    ...
    public DriverCals(){
        ...
        switch(type){
            case COMPETITION:
                ...
                angleOffset = new double[]{2.820, 3.759, 3.668, 0.060};
            break;
