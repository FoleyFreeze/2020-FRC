...
public class DriverCals extends CalSet {
    ...
    public MotorCal[] turnMotors = {   
        MotorCal.spark( 5).pid(0.00005, 0, 0.0000, 0).dFilt(0.3).limit(0.4, 0.4).brake().ramp(0.3), 
        MotorCal.spark(11).pid(0.00005, 0, 0.0000, 0).dFilt(0.3).limit(0.4, 0.4).brake().ramp(0.3), 
        MotorCal.spark( 4).pid(0.00005, 0, 0.0000, 0).dFilt(0.3).limit(0.4, 0.4).brake().ramp(0.3), 
        MotorCal.spark(10).pid(0.00005, 0, 0.0000, 0).dFilt(0.3).limit(0.4, 0.4).brake().ramp(0.3)};
