...
public class DriverCals extends CalSet {
    ...
    public MotorCal[] driveMotors = {   
        MotorCal.spark(20).ramp(0.3).limit(0.50).coast(), 
        MotorCal.spark( 1).ramp(0.3).limit(0.50).coast(), 
        MotorCal.spark(14).ramp(0.3).limit(0.50).coast(), 
        MotorCal.spark(15).ramp(0.3).limit(0.50).coast()};
