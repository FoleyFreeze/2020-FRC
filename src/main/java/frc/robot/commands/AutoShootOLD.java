...
public class AutoShootOLD extends CommandBase{
    ...
    public AutoShootOLD(Drivetrain drivetrain, CannonClimber cannon, Revolver revolver, Inputs input, Vision vision, RobotState state){
