...
public class Display extends SubsystemBase{
    ...
    public static void init(){
        ...
        map.put(nte.getName(), nte);
        nte = tab.add("Last Target", "abc").withPosition(3, 0).getEntry();
        map.put(nte.getName(), nte);
        nte = tab.add("Last Ball", "abc").withPosition(4, 0).getEntry();
        map.put(nte.getName(), nte);
        ...
        map.put(nte.getName(), nte);
        nte = tab.add("NavX Angle", 0.0).withPosition(3, 0).getEntry();
        map.put(nte.getName(), nte);
        ...
        map.put(nte.getName(), nte);
        nte = tab.add("Motor Current", 0.0).withPosition(2, 0).getEntry();
        map.put(nte.getName(), nte);
        nte = tab.add("Motor Temp", 0.0).withPosition(3, 0).getEntry();
        map.put(nte.getName(), nte);
